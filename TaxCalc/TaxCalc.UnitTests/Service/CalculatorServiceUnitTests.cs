    ...
    public class CalculatorServiceUnitTests
    {
        ...
        public void TestInitialize()
        {
            ...
            _calculator.Setup(c => c.LoadRules(It.IsAny<ITaxJurisdictionConfiguration>()))
                .Verifiable();
            _calculator.Setup(c => c.Calculate(It.IsAny<TaxPayer>()))
        ...
        public async Task Service_AllSetup_CorrectCallsAsync()
        {
            ...
            _calculator.Setup(s => s.Calculate(It.IsAny<TaxPayer>()))
                .ReturnsAsync(taxesOutput)
                .Verifiable();

            // Throws no exception
            var result = await service.Calculate(taxPayerDto);
            ...
            _calculator.Verify(c => c.Calculate(It.IsAny<TaxPayer>()), Times.Once);
        }
